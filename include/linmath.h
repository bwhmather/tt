...
#define LINMATH_H_DEFINE_VEC(n)                                             \
    ...
    LINMATH_H_FUNC float vec##n##_mul_inner(                                \
...
LINMATH_H_FUNC void mat4x4_scale_aniso(
    mat4x4 M, mat4x4 a, float x, float y, float z
) {
    int i;
...
LINMATH_H_FUNC void mat4x4_translate(
    mat4x4 T, float x, float y, float z
) {
    mat4x4_identity(T);
    T[3][0] = x;
    T[3][1] = y;
...
LINMATH_H_FUNC void mat4x4_arcball(
    mat4x4 R, mat4x4 M, vec2 _a, vec2 _b, float s
) {
