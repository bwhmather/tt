...
static TTBehaviourResult tt_behaviour_selector_do_call(
...
static TTBehaviourResult tt_behaviour_selector_do_resume(
    TTBehaviour *base, TTEntityId entity_id, void *fp
) {
    TTBehaviourLoop *behaviour = (TTBehaviourLoop *) base;
    TTBehaviourLoopState *state = (TTBehaviourLoopState *) fp;
...
static void tt_behaviour_selector_do_interrupt(
    TTBehaviour *base, TTEntityId entity_id, void *fp
) {
    TTBehaviourLoop *behaviour = (TTBehaviourLoop *) base;
    TTBehaviourLoopState *state = (TTBehaviourLoopState *) fp;
...
static size_t tt_behaviour_selector_max_stack_size(TTBehaviour *base) {
    TTBehaviourLoop *behaviour = (TTBehaviourLoop *) base;
...
static void tt_behaviour_selector_free(TTBehaviour *base) {
    TTBehaviourLoop *behaviour = (TTBehaviourLoop *) base;
