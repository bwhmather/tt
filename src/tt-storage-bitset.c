...
TTStorageBitset *
tt_storage_bitset_new(void) {
    TTStorageBitset *storage =
        (TTStorageBitset *)malloc(sizeof(TTStorageBitset));
...
void
tt_storage_bitset_free(TTStorageBitset *storage) {
    tt_assert(storage != NULL);
...
bool
tt_storage_bitset_contains(TTStorageBitset *storage, TTEntityId entity_id) {
    tt_assert(storage != NULL);
...
void
tt_storage_bitset_add(TTStorageBitset *storage, TTEntityId entity_id) {
    tt_assert(storage != NULL);
...
void
tt_storage_bitset_remove(TTStorageBitset *storage, TTEntityId entity_id) {
    tt_assert(storage != NULL);
