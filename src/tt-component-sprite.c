...
TTSprite *
tt_component_sprite_add(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
    tt_assert(!tt_storage_vector_has(state.storage, entity_id));

    TTSprite *sprite =
        (TTSprite *)tt_storage_vector_add(state.storage, entity_id);
...
bool
tt_component_sprite_has(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
...
TTSprite *
tt_component_sprite_get(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
    tt_assert(tt_storage_vector_has(state.storage, entity_id));
...
void
tt_component_sprite_remove(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
    tt_assert(tt_storage_vector_has(state.storage, entity_id));
