...
void
tt_component_wood_set(TTEntityId entity_id, int wood) {
    tt_assert(state.initialised == true);
...
bool
tt_component_wood_has(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
...
int
tt_component_wood_get(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
    tt_assert(tt_storage_vector_has(state.storage, entity_id));

    int *storage = (int *)tt_storage_vector_get(state.storage, entity_id);

    return *storage;
}

void
tt_component_wood_remove(TTEntityId entity_id) {
    tt_assert(state.initialised == true);
    tt_assert(tt_storage_vector_has(state.storage, entity_id));
