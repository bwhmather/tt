...
static void
tt_behaviour_sleep_init(
    TTBehaviourSleep *behaviour, TTBehaviourSleepState *state,
...
static void
tt_behaviour_sleep_free(TTBehaviourSleep *behaviour) {
    free(behaviour);
}
...
tt_behaviour_sleep(unsigned int num_frames) {
    TTBehaviourSleep *behaviour =
        (TTBehaviourSleep *)malloc(sizeof(TTBehaviourSleep));
